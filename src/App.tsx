...
function DashboardPage({ assets, dailySnapshots, activity, activityLoading = false, activityError = null, onRefreshActivity, market, setMarket, period, setPeriod, kind, setKind, navigate, priceHistory }: { assets: DemoAsset[]; dailySnapshots: PortfolioDailySnapshotV2[]; activity: readonly RecentActivityItemV3[]; activityLoading?: boolean; activityError?: string | null; onRefreshActivity?: () => void | Promise<void>; market: Market; setMarket: (market: Market) => void; period: Period; setPeriod: (period: Period) => void; kind: AssetKind | 'all'; setKind: (kind: AssetKind | 'all') => void; navigate: (path: string) => void; priceHistory?: UserCardPriceHistory }) {
